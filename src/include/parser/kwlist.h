...
PG_KEYWORD("agent", AGENT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("attestation", ATTESTATION, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("budget", BUDGET, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("context", CONTEXT_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("goal", GOAL, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("kind", KIND, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("known", KNOWN, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("namespace", NAMESPACE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("principal", PRINCIPAL, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("prior", PRIOR, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("priority", PRIORITY, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("profile", PROFILE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("receipt", RECEIPT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("remember", REMEMBER, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("resume", RESUME, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("run", RUN, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("runtime", RUNTIME, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("sandbox", SANDBOX, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("scope", SCOPE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("signer", SIGNER, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("tags", TAGS, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("token", TOKEN, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("tool", TOOL, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("tools", TOOLS, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("trace", TRACE, UNRESERVED_KEYWORD, BARE_LABEL)
